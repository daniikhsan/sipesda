...
<body>
    ...
    <center>
        <table style="font-size: 17px; text-align: justify; " width="100%">
            <tr>
    ...
    <p style="font-size: 17px; text-indent:60px; text-align: justify; line-height:1.5; margin-bottom: 10px;">Nama tersebut diatas adalah benar penduduk yang sampai saat ini berdomosili di alamat tersebut di atas. Surat keterangan domisili ini dipergunakan sebagai persyaratan {{ $domisili->keterangan }}.</p>

    <p style="font-size: 17px; text-indent:60px; text-align: justify; line-height:1.5; margin-bottom: 30px;">Demikian Surat Keterangan Domisili ini diberikan yang bersangkutan untuk dapat dipergunakan sebagaimana mestinya.</p>
