            ...
            <div class="card-body">
                <form action="{{ route('admin.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_kk') is-invalid @enderror" id="no_kk" name="no_kk" value="{{ old('no_kk') }}" placeholder="Input No Kartu Keluarga...">
                        @error('no_kk')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jabatan_perangkat_desa') is-invalid @enderror" id="jabatan_perangkat_desa" name="jabatan_perangkat_desa" value="{{ old('jabatan_perangkat_desa') }}" placeholder="Input Posisi...">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control  @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Input Tempat Lahir...">
                                @error('tempat_lahir')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-9">
                                ...
                                <input type="date" class="form-control  @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" placeholder="Input Tanggal Lahir...">
                                @error('tanggal_lahir')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pendidikan" id="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror">
                            ...
                            <option value="Tidak Tamat SD/Sederajat" {{ old('pendidikan') == 'Tidak Tamat SD/Sederajat' ? 'selected' : '' }}>Tidak Tamat SD/Sederajat</option>
                            ...
                            <option value="Akademi/Diploma III/Sarjana Muda" {{ old('pendidikan') == 'Akademi/Diploma III/Sarjana Muda' ? 'selected' : '' }}>Akademi/Diploma III/Sarjana Muda</option>
