...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('domisili.update', $sk_domisili->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <select name="jenis_domisili" id="jenis_domisili" class="form-control @error('jenis_domisili') is-invalid @enderror" required>
                            ...
                            <option value="Penduduk" {{ old('jenis_domisili', $sk_domisili->jenis_domisili) == 'Penduduk' ? 'selected' : '' }}>Penduduk</option>
                            <option value="Persyaratan" {{ old('jenis_domisili', $sk_domisili->jenis_domisili) == 'Persyaratan' ? 'selected' : '' }}>Persyaratan</option>
                            <option value="Usaha" {{ old('jenis_domisili', $sk_domisili->jenis_domisili) == 'Usaha' ? 'selected' : '' }}>Usaha</option>
                            <option value="Lainnya" {{ old('jenis_domisili', $sk_domisili->jenis_domisili) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div class="mb-3" id="input_nik" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{ old('nik', $sk_domisili->nik) }}" placeholder="Input NIK...">
                        @error('nik')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_nama" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $sk_domisili->nama) }}" placeholder="Input nama...">
                        @error('nama')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_tempat_tanggal_lahir" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('tempat_tanggal_lahir') is-invalid @enderror" id="tempat_tanggal_lahir" name="tempat_tanggal_lahir" value="{{ old('tempat_tanggal_lahir' , $sk_domisili->tempat_tanggal_lahir) }}" placeholder="Input Tempat Tanggal Lahir...">
                    ...
                    <div class="mb-3" id="input_jenis_kelamin" style="display:none;">
                        ...
                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror">
                            ...
                            <option value="Laki-Laki" {{ old('jenis_kelamin', $sk_domisili->jenis_kelamin) == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                            <option value="Perempuan" {{ old('jenis_kelamin', $sk_domisili->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                        @error('jenis_kelamin')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="mb-3" id="input_agama" style="display:none;">
                        ...
                        <select name="agama" id="agama" class="form-control @error('agama') is-invalid @enderror">
                            ...
                            <option value="Islam" {{ old('agama', $sk_domisili->agama) == 'Islam' ? 'selected' : '' }}>Islam</option>
                            <option value="Protestan" {{ old('agama', $sk_domisili->agama) == 'Protestan' ? 'selected' : '' }}>Protestan</option>
                            <option value="Katholik" {{ old('agama', $sk_domisili->agama) == 'Katholik' ? 'selected' : '' }}>Katholik</option>
                            <option value="Hindu" {{ old('agama', $sk_domisili->agama) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                            <option value="Buddha" {{ old('agama', $sk_domisili->agama) == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                            <option value="Konghucu" {{ old('agama', $sk_domisili->agama) == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                        </select>
                        @error('agama')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="mb-3" id="input_status_perkawinan" style="display:none;">
                        ...
                        <select name="status_perkawinan" id="status_perkawinan" class="form-control @error('status_perkawinan') is-invalid @enderror">
                            ...
                            <option value="Belum Kawin" {{ old('status_perkawinan', $sk_domisili->status_perkawinan) == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin</option>
                            <option value="Kawin" {{ old('status_perkawinan', $sk_domisili->status_perkawinan) == 'Kawin' ? 'selected' : '' }}>Kawin</option>
                            <option value="Cerai Hidup" {{ old('status_perkawinan', $sk_domisili->status_perkawinan) == 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup</option>
                            <option value="Cerai Mati" {{ old('status_perkawinan', $sk_domisili->status_perkawinan) == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati</option>
                        </select>
                    ...
                    <div class="mb-3" id="input_pekerjaan" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan', $sk_domisili->pekerjaan) }}" placeholder="Input Pekerjaan...">
                        @error('pekerjaan')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_alamat_asal" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('alamat_asal') is-invalid @enderror" id="alamat_asal" name="alamat_asal" value="{{ old('alamat_asal', $sk_domisili->alamat_asal) }}" placeholder="Input Alamat Asal...">
                        @error('alamat_asal')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_alamat_domisili" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('alamat_domisili') is-invalid @enderror" id="alamat_domisili" name="alamat_domisili" value="{{ old('alamat_domisili', $sk_domisili->alamat_domisili) }}" placeholder="Input Alamat Domisili...">
                    ...
                    <div class="mb-3" id="input_masa_berlaku" style="display:none;">
                        ...
                        <input type="date" class="form-control @error('tanggal_berlaku') is-invalid @enderror" id="tanggal_berlaku" name="tanggal_berlaku" value="{{ old('tanggal_berlaku', $sk_domisili->tanggal_berlaku) }}" placeholder="Input Masa Berlaku...">
                    ...
                    <div class="mb-3" id="input_nama_usaha" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('nama_usaha') is-invalid @enderror" id="nama_usaha" name="nama_usaha" value="{{ old('nama_usaha', $sk_domisili->nama_usaha) }}" placeholder="Input Nama Usaha...">
                        @error('nama_usaha')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_bidang_usaha" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('bidang_usaha') is-invalid @enderror" id="bidang_usaha" name="bidang_usaha" value="{{ old('bidang_usaha', $sk_domisili->bidang_usaha) }}" placeholder="Input Bidang Usaha...">
                        @error('bidang_usaha')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_mulai_usaha" style="display:none;">
                        ...
                        <input type="date" class="form-control @error('mulai_usaha') is-invalid @enderror" id="mulai_usaha" name="mulai_usaha" value="{{ old('mulai_usaha', $sk_domisili->mulai_usaha) }}" placeholder="Input Mulai Usaha...">
                        @error('mulai_usaha')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3" id="input_keterangan" style="display:none;">
                        ...
                        <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" value="{{ old('keterangan', $sk_domisili->keterangan) }}" placeholder="Input Keterangan...">
                        @error('keterangan')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
...
<script>
    ...
    let get_value_jenis_domisili = '{{ $sk_domisili->jenis_domisili }}'

    if(get_value_jenis_domisili == 'Penduduk'){
        hideAllInput()
        PendudukForm()
    }else if(get_value_jenis_domisili == 'Persyaratan'){
        hideAllInput()
        PersyaratanForm()
    }else if(get_value_jenis_domisili == 'Usaha'){
        hideAllInput()
        UsahaForm()
    }else{
        hideAllInput()
